...
{
    ros::init(argc, argv, "rsv_joint_interface");
    ...
    rsv_joint_interface::RsvJointInterface hardware_interface;
    ...
    while (ros::ok())
    {
        ...
        //int sleep_time_milli = 10;
        //usleep(sleep_time_milli*1000);
    }
    
    spinner.stop();
    ROS_INFO_STREAM_NAMED("rsv_joint_interface", "Shutting down.");
