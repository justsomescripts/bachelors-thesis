...
class MoveGroupPythonInterface(object):
    ...
    def go_to_scan_pose(self):
        ...
        scan_pose_goal.position.x = REF_X
        scan_pose_goal.position.y = REF_Y
        scan_pose_goal.position.z = REF_Z                    # z setzt sich zusammen aus: 0.9m Tischhöhe und 0.56m über dem Tisch
